  ...
  return (
    <div className="flex min-h-dvh">
      ...
      <main className="flex-1 p-8 space-y-16">
        ...
        {/* Inputs Section */}
        <Section id="inputs" title="Input Components">
          ...
          <Subsection title="Textarea">
            <Textarea placeholder="Enter your message..." className="w-80" />
          </Subsection>
        ...
        {/* Selections Section */}
        <Section id="selections" title="Selection Components">
        ...
        {/* App Dialogs Section */}
        <Section id="app-dialogs" title="App Dialogs (useDialog)">
        ...
        <Section id="toast" title="Toast (Sonner)">
          <Subsection title="Basic Types">
            ...
            <Button variant="info-light" onClick={() => toast.info('Here is some information')}>
              Info
            </Button>
          </Subsection>
