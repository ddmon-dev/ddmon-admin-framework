...
const Editor = dynamic(
  () => import('@/shared/ui/editor/editor').then(mod => ({ default: mod.Editor })),
  {
    ssr: false,
    loading: () => (
      <div className='flex h-[300px] items-center justify-center'>에디터 로딩 중...</div>
    ),
  }
);
    ...
    <div className='space-y-6'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            CKEditor 5 기반의 강력한 리치 텍스트 에디터입니다. 워드프로세서 수준의 편집 기능, 이미지
