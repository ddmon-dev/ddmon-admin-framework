...
export function HeroSection() {
  ...
  return (
    <section className='pt-4 px-4 md:px-0 mb-8 md:pt-6 md:mb-12 text-center md:text-left font-secondary'>
      ...
      <p className='text-[28px] md:text-[40px] font-thin text-secondary-foreground/70 tracking-tighter leading-[1.2]'>
        {getTimeGreeting()}
      </p>
    </section>
  );
