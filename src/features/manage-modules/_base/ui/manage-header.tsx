...
export function ManageModuleHeader({ moduleName, headerAddons }: ManageModuleHeaderProps) {
  return (
    <header className={cn('border-b sticky top-0 z-10 bg-background rounded-t-xl')}>
      <Container className={cn('py-3! grid gap-2')}>
        <div className='flex items-center gap-2'>
          <SidebarTrigger />
          <Separator
            orientation='vertical'
            className={cn('data-[orientation=vertical]:h-4 mx-1')}
          />
